...
class OptionTest(unittest.TestCase):
    ...
    def test_unwrap(self):
        x: monad_std.option.Option[str] = monad_std.option.Option.of_some("value")
        ...
        self.assertEqual(monad_std.option.Option.of_some("car").unwrap_or("bike"), "car")
        self.assertEqual(monad_std.option.Option.of_none().unwrap_or("bike"), "bike")

        k = 10
        self.assertEqual(monad_std.option.Option.of_some(4).unwrap_or_else(lambda: 2 * k), 4)
        self.assertEqual(monad_std.option.Option.of_none().unwrap_or_else(lambda: 2 * k), 20)

        self.assertEqual(monad_std.option.Option.of_some(4).unwrap_unchecked(), 4)
        self.assertTrue(monad_std.option.Option.of_none().unwrap_unchecked() is None)
    ...
    def test_map(self):
        ...
        self.assertEqual(monad_std.option.Option.of_none().map_or(42, lambda s: len(s)), 42)

        k = 21
        self.assertEqual(
            monad_std.option.Option.of_some("bar").map_or_else(lambda: 2 * k, lambda s: len(s)),
            3,
        )
        self.assertEqual(
            monad_std.option.Option.of_none().map_or_else(lambda: 2 * k, lambda s: len(s)),
            42,
        )
    ...
    def test_bool_eval(self):
        self.assertEqual(
            monad_std.option.Option.of_some(2).bool_and(monad_std.option.Option.of_none()),
            monad_std.option.Option.of_none(),
        )
        self.assertEqual(
            monad_std.option.Option.of_none().bool_and(monad_std.option.Option.of_some("foo")),
            monad_std.option.Option.of_none(),
        )
        self.assertEqual(
            monad_std.option.Option.of_some(2).bool_and(monad_std.option.Option.of_some("bar")),
            monad_std.option.Option.of_some("bar"),
        )
        self.assertEqual(
            monad_std.option.Option.of_none().bool_and(monad_std.option.Option.of_none()),
            monad_std.option.Option.of_none(),
        )

        self.assertEqual(
            monad_std.option.Option.of_some(2).bool_or(monad_std.option.Option.of_none()),
            monad_std.option.Option.of_some(2),
        )
        self.assertEqual(
            monad_std.option.Option.of_none().bool_or(monad_std.option.Option.of_some(100)),
            monad_std.option.Option.of_some(100),
        )
        self.assertEqual(
            monad_std.option.Option.of_some(2).bool_or(monad_std.option.Option.of_some(100)),
            monad_std.option.Option.of_some(2),
        )
        self.assertEqual(
            monad_std.option.Option.of_none().bool_or(monad_std.option.Option.of_none()),
            monad_std.option.Option.of_none(),
        )

        self.assertEqual(
            monad_std.option.Option.of_some(2).bool_xor(monad_std.option.Option.of_none()),
            monad_std.option.Option.of_some(2),
        )
        self.assertEqual(
            monad_std.option.Option.of_none().bool_xor(monad_std.option.Option.of_some(2)),
            monad_std.option.Option.of_some(2),
        )
        self.assertEqual(
            monad_std.option.Option.of_some(2).bool_xor(monad_std.option.Option.of_some(2)),
            monad_std.option.Option.of_none(),
        )
        self.assertEqual(
            monad_std.option.Option.of_none().bool_xor(monad_std.option.Option.of_none()),
            monad_std.option.Option.of_none(),
        )

    def test_chain(self):
        self.assertEqual(
            monad_std.option.Option.of_some(2).and_then(lambda x: monad_std.option.Option.of_some(str(x))),
            monad_std.option.Option.of_some("2"),
        )
        self.assertEqual(
            monad_std.option.Option.of_some(10).and_then(lambda _: monad_std.option.Option.of_none()),
            monad_std.option.Option.of_none(),
        )
        self.assertEqual(
            monad_std.option.Option.of_none().and_then(lambda x: monad_std.option.Option.of_some(str(x))),
            monad_std.option.Option.of_none(),
        )
        ...
        self.assertEqual(
            monad_std.option.Option.of_some("foo").or_else(lambda: monad_std.option.Option.of_some("bar")),
            monad_std.option.Option.of_some("foo"),
        )
        self.assertEqual(
            monad_std.option.Option.of_none().or_else(lambda: monad_std.option.Option.of_some("bar")),
            monad_std.option.Option.of_some("bar"),
        )
        self.assertEqual(
            monad_std.option.Option.of_none().or_else(lambda: monad_std.option.Option.of_none()),
            monad_std.option.Option.of_none(),
        )
        ...
        self.assertEqual(
            monad_std.option.Option.of_some(1).zip(monad_std.option.Option.of_some("hi")),
            monad_std.option.Option.of_some((1, "hi")),
        )
        self.assertEqual(
            monad_std.option.Option.of_some(1).zip(monad_std.option.Option.of_none()),
            monad_std.option.Option.of_none(),
        )
        ...
        self.assertEqual(
            monad_std.option.Option.of_some(2).zip_with(monad_std.option.Option.of_some(4), make_point),
            monad_std.option.Option.of_some({"x": 2, "y": 4}),
        )
        self.assertEqual(
            monad_std.option.Option.of_some(2).zip_with(monad_std.option.Option.of_none(), make_point),
            monad_std.option.Option.of_none(),
        )

    def test_unzip(self):
        self.assertTupleEqual(
            monad_std.option.Option.unzip(monad_std.option.Option.of_some((1, "hi"))),
            (
    ...
    def test_flatten(self):
        self.assertEqual(
            monad_std.option.Option.flatten(monad_std.option.Option.of_some(monad_std.option.Option.of_some(6))),
            monad_std.option.Option.of_some(6),
        )
        self.assertEqual(
            monad_std.option.Option.flatten(monad_std.option.Option.of_some(monad_std.option.Option.of_none())),
            monad_std.option.Option.of_none(),
        )
        self.assertEqual(
        ...
        self.assertEqual(
            monad_std.option.Option.flatten(
                monad_std.option.Option.of_some(monad_std.option.Option.of_some(monad_std.option.Option.of_some(6)))
            ),
